...
demo = {
    ...
    initMaterialUpdateWizard: function() {
        // Code for the Validator
        var $validator = $('.wizard-card form').validate({
            rules: {
                firstname: {
        ...
        if (type == 'basic') {
            ...
            swal({
                ...
                swal({
                    ...
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                }).then(account_delete(id)).catch(swal.noop)
            }, function(dismiss) {
                // dismiss can be 'overlay', 'cancel', 'close', 'esc', 'timer'
                if (dismiss === 'cancel') {
                    swal({
                        title: 'Cancelled',
                        text: 'This account is safe :)',
                        type: 'error',
                        confirmButtonClass: "btn btn-info",
                        buttonsStyling: false
                    }).catch(swal.noop)
            ...
            swal({
                ...
                text: "Please check your credential again",
                timer: 2000,
    ...
    initSmallGoogleMaps: function() {
        ...
        // Regular Map
        var myLatlng = new google.maps.LatLng(23.614328, 58.545284);
        var mapOptions = {
            zoom: 8,
            center: myLatlng,
            scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
